...
public class RecurringOnlyCount {
	...
	public static List<Map<String, Object>> recurringData(Context context,
		...
		List<Map<String, Object>> tDataList = BillsDaoOnlyCount.selectTemplateBillRuleByBE(context);
		 ...
		 */
		List<Map<String, Object>>oDataList = BillsDaoOnlyCount.selectBillItemByBE(context, start, end);
//		Log.v("mtest", "特例结果大小" + oDataList.size());
		...
		List<Map<String, Object>> mOrdinaryList = BillsDaoOnlyCount.selectOrdinaryBillRuleByBE(context, start, end);
