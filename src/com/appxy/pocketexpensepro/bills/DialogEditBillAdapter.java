...
import android.widget.TextView;
	...
	public class DialogEditBillAdapter extends BaseAdapter{
		
		private final String[] data = {"Change only this bill","Change this and all future bills"};
		
		private LayoutInflater mInflater;
		private Context context;
		private int conut = 2;
		    
	    public  DialogEditBillAdapter(Context context) {
