...
public class BillPayListViewAdapter extends BaseAdapter {
	private Context context;
	private List<Map<String, Object>> mData;
	private LayoutInflater mInflater;

	public BillPayListViewAdapter(Context context) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		viewholder.accountTextView.setText( (String)mData.get(position).get("accName"));
		viewholder.currencyTextView.setText(Common.CURRENCY_SIGN[Common.CURRENCY]);
		long dueDate = (Long) mData.get(position).get("dateTime");
