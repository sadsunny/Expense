				...
				if (mViewList != null && mViewList.size() > 0) {
					for (int i = 0; i < mViewList.size(); i++) {
						...
						if (amount > 0) {
							...
							long temId = BudgetsDao.insertBudgetTemplate(CreatBudgetsActivity.this, amountString,categoryId,dateTime, mDbxAcctMgr , mDatastore);
							
							if (temId > 0) {
								long itemId = BudgetsDao.insertBudgetItem(CreatBudgetsActivity.this, amountString,(int) temId, dateTime,  mDbxAcctMgr, mDatastore);
							}
