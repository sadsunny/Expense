...
public class SplitCategoryActivity extends BaseHomeActivity {
	...
	private Handler mHandler = new Handler() {
		public void handleMessage(Message msg) {
			...
			case MSG_FAILURE:
				Toast.makeText(SplitCategoryActivity.this, "Exception",
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		inflater = LayoutInflater.from(SplitCategoryActivity.this);
	...
	public Runnable mTask = new Runnable() {
		...
		public void run() {
			// TODO Auto-generated method stub
			mDataList = TransactionDao.selectCategory(SplitCategoryActivity.this);
			...
			case R.id.action_done:
				...
				if (mViewList != null && mViewList.size() > 0) {
					...
					for (int i = 0; i < mViewList.size(); i++) {
						...
						if (amount > 0) {
							int categoryId = (Integer) mDataList.get(i).get("_id");
