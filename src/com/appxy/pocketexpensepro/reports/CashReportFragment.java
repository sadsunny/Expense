...
public class CashReportFragment extends Fragment implements
	...
	private Handler mHandler = new Handler() {
		public void handleMessage(Message msg) {
			...
			case MSG_SUCCESS:
				...
				barChart = (GraphicalView) ChartFactory.getBarChartView(mActivity, dataset, getBarRenderer(labelArrayList), Type.DEFAULT);
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		// TODO Auto-generated method stub
		View view = inflater.inflate(R.layout.fragment_report_cashv2, container,
				false);
		mInflater = inflater;
		...
		public void run() {
			...
			List<Map<String, Object>> mDataList = OverViewDao
					.selectTransactionByTimeBE(mActivity,
							MainActivity.startCashDate, MainActivity.endCashDate);
	...
	public XYMultipleSeriesRenderer getBarRenderer(ArrayList<String> xLable) {
		...
		renderer.setMargins(new int[] { MEntity.dip2px(mActivity, 10),
				0, MEntity.dip2px(mActivity, 8), 0 }); // 设置4边留白上左下右
		...
		renderer.setPanLimits(new double[] { -0.5, xLable.size() +0.4, 0,
				0}); // 设置左右拉伸的界限
	...
	private void iniPopupWindow() {
		...
		lvPopupList.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				...
				rangButton.setText(getPopupData().get(MainActivity.rangeCashPositon).get("item"));
				rangeType = arg2;
				setRangDate(arg2);
			}
		});
	...
	public void setRangDate(int rangPosition) {
	 ...
	 if (rangPosition == 0) {
			...
			MainActivity.startCashDate = MEntity.getFirstDayOfMonthMillis(c6.getTimeInMillis());
			mHandler.post(mTask);
	...
	public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
		...
		rangButton.setText(getPopupData().get(MainActivity.rangeCashPositon).get(
				"item"));
