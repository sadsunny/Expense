...
public class CategorysReportFragment extends Fragment implements OnSyncFinishedListener{
	...
	public CategorysReportFragment() {
	...
	public void onResume() {
		...
		currency1.setText(Common.CURRENCY_SIGN[Common.CURRENCY]);
		currency2.setText(Common.CURRENCY_SIGN[Common.CURRENCY]);
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		// TODO Auto-generated method stub
		View view = inflater.inflate(R.layout.fragment_report_overviewv2,
				container, false);
		mInflater = inflater;
		iniPopupWindow();
		mCategoryDataList = new ArrayList<Map<String, Object>>();
		
		dateTextView = (TextView) view.findViewById(R.id.date1);
		pieLayout = (LinearLayout) view.findViewById(R.id.PieChartLayout);
		mListView = (ListView) view.findViewById(R.id.mListView);
		expenseLayout = (RelativeLayout)view.findViewById(R.id.expenseLayout);
		incomeLayout = (RelativeLayout)view.findViewById(R.id.incomeLayout);
		expenseLabel = (TextView)view.findViewById(R.id.expeselabel);
		incomeLabel = (TextView)view.findViewById(R.id.incomelabel);
		...
		incomeAmount = (TextView)view.findViewById(R.id.incomeAmount);
		...
		expenseLayout.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				mCategoryType = 0;
				expenseLayout.setBackgroundResource(R.drawable.report_expense_selected_sharp);
				incomeLayout.setBackgroundColor(Color.WHITE);
				mHandler.post(mTask);
				
				expenseLabel.setTextColor(Color.WHITE);
				currency1.setTextColor(Color.WHITE);
				expenseAmount.setTextColor(Color.WHITE);
		...
		incomeLayout.setOnClickListener(new OnClickListener() {
			
			@Override
			public void onClick(View v) {
				// TODO Auto-generated method stub
				mCategoryType = 1;
				expenseLayout.setBackgroundColor(Color.WHITE);
				incomeLayout.setBackgroundResource(R.drawable.report_income_selected_sharp);
				mHandler.post(mTask);
				
				expenseLabel.setTextColor(Color.BLACK);
				currency1.setTextColor(Color.BLACK);
				expenseAmount.setTextColor(Color.BLACK);
				incomeLabel.setTextColor(Color.WHITE);
				currency2.setTextColor(Color.WHITE);
				incomeAmount.setTextColor(Color.WHITE);
			}
		});
