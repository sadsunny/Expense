		...
		payeeEditText.addTextChangedListener(new TextWatcher() {
			...
			public void onTextChanged(CharSequence s, int start, int before,
				...
				mCursor = TransactionDao.selectPayee(
						EditTransferActivity.this, MEntity.sqliteEscape(s.toString()));
				autoListAdapter = new AutoListAdapter(
						EditTransferActivity.this, mCursor, true);
...
//				showKeyboardWithAnimation();
		...
		customKeyBoard = new KeyboardUtil(EditTransferActivity.this, EditTransferActivity.this, amountEditText); 
...
public boolean judgMentPayee(String pName,int category){
		...
		boolean tag = false;
		List<Map<String, Object>> mList = PayeeDao.checkPayeeByNameAndCaegory(EditTransferActivity.this, pName, category);
		if (mList.size() > 0) {
			tag = true;
