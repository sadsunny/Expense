...
public class DialogExpandableListViewAdapter extends BaseExpandableListAdapter {
	...
	public DialogExpandableListViewAdapter(Context context) {

		inflater = LayoutInflater.from(context);
	}

	public void setSelectedPosition(int gPosition, int cPosition) {
		this.mGroupPosition = gPosition;
		this.mChildPosition = cPosition;
	}
	...
	public View getGroupView(int groupPosition, boolean isExpanded,
		...
		if (mGroupPosition == groupPosition && mChildPosition == -1) {
