...
public class RecurringEventBEHasReminder {
	...
	public static List<Map<String, Object>> recurringData(Context context,
		...
		List<Map<String, Object>> tDataList = ServiceDao.selectTemplateBillRuleByBE(context);
		 ...
		 */
		List<Map<String, Object>>oDataList = ServiceDao.selectBillItemByBE(context, start, end);
		...
		List<Map<String, Object>> mOrdinaryList = ServiceDao.selectOrdinaryBillRuleByBE(context, start, end);
